 ...
 *	@author			Christian Würker <christian.wuerker@ceusmedia.de>
 */
class Header_SectionTest extends PHPUnit_Framework_TestCase
{
	...
	public function testGetFields(){
		$field1		= new \CeusMedia\Mail\Header\Field( "key", "value" );
		$field2		= new \CeusMedia\Mail\Header\Field( "kEY", "value" );
		$section	= new \CeusMedia\Mail\Header\Section();
	...
	public function testGetFieldsByName(){
		$field1		= new \CeusMedia\Mail\Header\Field( "key", "value" );
		$field2		= new \CeusMedia\Mail\Header\Field( "kEY", "value" );
		$field3		= new \CeusMedia\Mail\Header\Field( "ABC", "DEF" );
		$section	= new \CeusMedia\Mail\Header\Section();
